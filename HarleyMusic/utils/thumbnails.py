...
async def get_thumb(videoid,user_id):
    ...
    try:
        ...
        bg = Image.open(f"HarleyMusic/assets/riyu.png")
        ...
        font = ImageFont.truetype("HarleyMusic/assets/font.ttf", 45)
        ImageFont.truetype("HarleyMusic/assets/font2.ttf", 70)
        arial = ImageFont.truetype("HarleyMusic/assets/font.ttf", 30)
        ImageFont.truetype("HarleyMusic/assets/font.ttf", 30)
